...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        $('#audio').show(0).find('input').prop('disabled',false);
        $('#advanced').hide(0);
        $('#image').hide(0).find('input').prop('disabled',true);
        $('#normal').hide(0).find('input').prop('disabled',true);
        $('#video').hide(0).find('input').prop('disabled',true);
        $('#external').hide(0).find('input').prop('disabled',true);
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\profile_tones_backend\resources\views/content/form.blade.php ENDPATH**/ ?>