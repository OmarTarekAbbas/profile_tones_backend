                ...
                <div class="modal-content">
                    ...
                    <div class="dis">
                        <ul>
                            ...
                            {{-- <li>لإلغاء الإشتراك بإرسال رسالة نصية، لمشتركى اورنج: إرسال كلمة "stop islamic services" إلى الرقم المجانى 5030 ، لمشتركى اتصالات: إرسال "stop islamic services" إلى الرقم المجانى 1722 ، لمشتركى شبكة فودافون: ارسال "stop islamic services" إلى الرقم المجانى 6699</li>--}}
                            <li>لإلغاء الإشتراك بإرسال رسالة نصية، لمشتركى اورنج: إرسال كلمة "stop islamic services" إلى الرقم المجانى 5030 ، لمشتركى شبكة فودافون: ارسال "stop islamic services" إلى الرقم المجانى 6699</li>
                            <p>او عن طريق هذا <a href="{{url('unsub')}}"> الرابط </a> </p>
                            <li>برجاء إرسال اى أسئلة أو شكاوى عن الخدمة إلى support@islamicservices.com</li>
                        </ul>
                    </div>
...
--}}
                        ...
                        <input type="submit" value="إشترك" class="btn" style=" background-color: #e9a630; color: white; width: 100px; font-size: 25px; margin-bottom: 0;" />
