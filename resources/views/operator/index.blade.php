						...
						@foreach($operators as $operator)
							<tr class="table-flag-blue">
                                ...
                                <td>
                                    ...
                                    <input type="text" id="url_h{{ $operator->id }}" value="{{url(url('/?op='.$operator->id))}}">
                                    <span class="btn" onclick="x = document.getElementById('url_h{{ $operator->id }}'); x.select();document.execCommand('copy')"> <i class="fa fa-copy"></i> </span>
                                </td>
